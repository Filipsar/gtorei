    ...
    <div className="space-y-4">
        ...
        <div className="p-4 bg-card rounded-lg border border-border animate-slide-up">
          ...
          <div className="flex gap-2">
            <Button
              variant="outline"
              size="sm"
              onClick={() => setRaiseSize(Math.round(pot * 0.5))}
              className="flex-1"
            >
              50%
            </Button>
            <Button
              variant="outline"
              size="sm"
              onClick={() => setRaiseSize(Math.round(pot * 0.75))}
              className="flex-1"
            >
              75%
            </Button>
            ...
            <Button
              ...
              className="flex-1 bg-poker-raise hover:bg-poker-raise/90"
            >
              Confirmar
            </Button>
          </div>
      ...
      <div className="grid grid-cols-4 gap-2 sm:gap-3">
        <Button
          ...
          disabled={disabled}
          className={cn(
            'h-14 sm:h-16 flex flex-col items-center justify-center gap-1',
        ...
        <Button
          ...
          className={cn(
            'h-14 sm:h-16 flex flex-col items-center justify-center gap-1',
            'bg-poker-raise hover:bg-poker-raise/90 border-emerald-500',
            'text-white font-semibold',
            showSlider && 'ring-2 ring-primary'
          )}
        >
          <span className="text-lg">↑</span>
        ...
        <Button
          ...
          className={cn(
            'h-14 sm:h-16 flex flex-col items-center justify-center gap-1',
            'bg-poker-allin hover:bg-poker-allin/90 border-red-500',
            'text-white font-semibold'
          )}
        >
          <span className="text-lg">💥</span>
