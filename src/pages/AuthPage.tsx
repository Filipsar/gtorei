 ...
 const signupSchema = z.object({
   username: z.string().min(3, 'Nome deve ter no mínimo 3 caracteres').max(20, 'Nome deve ter no máximo 20 caracteres'),
   email: z.string().email('E-mail inválido'),
       ...
       <div className="w-full max-w-md">
         ...
         <div className="flex flex-col items-center mb-8">
           <div className="relative">
             <img src={gtoreiLogo} alt="GTORei" className="h-20 w-20 object-contain" />
             <Crown className="absolute -top-2 -right-2 h-6 w-6 text-primary" />
           </div>
           <h1 className="text-3xl font-bold text-primary mt-4">GTORei</h1>
           <p className="text-muted-foreground">Treine seu jogo GTO</p>
         </div>
         ...
         <Card className="border-border/50 shadow-xl">
           <CardHeader className="text-center pb-2">
             ...
             <CardDescription>
               Entre ou crie sua conta para começar a treinar
             </CardDescription>
           </CardHeader>
           <CardContent>
             {/* Google Sign In */}
